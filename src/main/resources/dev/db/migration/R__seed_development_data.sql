...
MERGE INTO financial_transaction (
    ...
    ('40000000-0000-0000-0000-000000000002', '00000000-0000-0000-0000-000000000001',
     ...
     125.45, 'EXPENSE', DATE '2026-08-29', 'Weekly groceries',
    ...
    ('40000000-0000-0000-0000-000000000003', '00000000-0000-0000-0000-000000000001',
     ...
     48.20, 'EXPENSE', DATE '2026-08-30', 'Dinner with friends',
...
SET current_balance = CASE id
    WHEN '10000000-0000-0000-0000-000000000001' THEN 4814.36
    WHEN '10000000-0000-0000-0000-000000000002' THEN 10518.25
    WHEN '10000000-0000-0000-0000-000000000003' THEN 549.25
